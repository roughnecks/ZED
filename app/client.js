...
async function parseMessage(groupID, chatID, message, senderID, senderAccountID, sender) {
    ...
    if (message === "!hello") {
        ...
        zed.manager._steam.chat.sendChatMessage(groupID, chatID, "Listen to our StillStream Radio using you favorite music player and connecting to: https://woodpeckersnest.space:8090/live");
