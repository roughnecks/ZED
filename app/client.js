...
zed.manager._steam.on('friendMessage', function (steamID, message) {
    ...
    if (message === "!help") {
        zed.manager._steam.chatMessage(steamID, 'Hello, if you want me to sign your profile, type "!sign" without the quotes. Also join my group chat for more: https://steamcommunity.com/groups/zedspace Have a nice day!');
    }
...
async function parseMessage(groupID, chatID, message, senderID, senderAccountID, sender) {
    ...
    if (message === "!hello") {
        ...
        zed.manager._steam.chat.sendChatMessage(groupID, chatID, "Listen to our StillStream Radio - Mixxxed Games Soundtracks. Use you favorite music player and connect to: http://woodpeckersnest.space:8090/live");
